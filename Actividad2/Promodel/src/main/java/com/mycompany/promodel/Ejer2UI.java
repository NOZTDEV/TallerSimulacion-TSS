...
public class Ejer2UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        numeroIteraciones = new JTextField("2000");  // Campo de texto para número de iteraciones
        tiempoSimulacion = new JTextField("10");   // Campo de texto para tiempo de simulación
        ...
        jLabel4.setText("Piezas a simular:");   // Etiqueta para tiempo de simulación
